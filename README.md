...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    ...
    display: block starts on a new line and takes up the whole width. display: inline displays the element as an inline element. Height and width properties will have no effect.
